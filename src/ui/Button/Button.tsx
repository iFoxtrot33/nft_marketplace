...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all outline-none rounded-lg w-full relative overflow-hidden cursor-pointer',
  {
    variants: {
      variant: {
        primary:
        ...
        success:
          'text-white hover:opacity-90 active:scale-95 !bg-[var(--color-green-dark)] border-none shadow-[0_4px_8.3px_0_var(--color-green-light),inset_0_1px_0_rgba(255,255,255,0.2)]',
        disabled:
